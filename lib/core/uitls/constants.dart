...
DateTime nextPrayerTime = DateTime(2023, 8, 8, 16, 38); // Example: Next prayer time at 2:00 PM
...
SvgPicture createImageSvg(String svgString , [double width = 500 , double height = 500])
{
...
List<ImageProvider> playerTimeIcon =[AppImages.iconfajr,AppImages.iconsunrise ,  AppImages.icondhuhr,AppImages.iconAsr,AppImages.icondmaghrip,AppImages.iconisha,];

List<Color> playerTimeIconColor = [ColorsManager.mainColor,ColorsManager.greenboldColor,ColorsManager.greenLightColor,ColorsManager.blueLightColor,ColorsManager.blueLight2Color,ColorsManager.blueColor,];